export type PhaseId = "truth" | "wedge" | "proof" | "distribution" | "convert";
export type Impact = "critical" | "high" | "medium";
export type Horizon = "this_week" | "this_month" | "quarter";
...
export const NORTH_STAR = {
  ...
  statement:
    "An external agent client installs the TWZRD buyer gate and honors block before the wallet signs — proven by gate_evals and refuse transcripts, not by free MCP hits.",
...
export const FUNNEL_STAGES = [
  {
    key: "external_cards" as const,
    label: "External free cards",
    hint: "Advisory demand only",
  },
  {
    key: "gate_evals" as const,
    label: "Gate evals",
    hint: "Path B — primary",
  },
  {
    key: "gate_blocks" as const,
    label: "Gate blocks",
    hint: "Refusals that saved spend",
  },
  {
    key: "paid_external" as const,
